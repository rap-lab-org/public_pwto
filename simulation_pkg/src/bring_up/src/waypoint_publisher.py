...
class WaypointPublisher(object):
    ...
    def __init__(self):
        ...
        self.pub_wp = rospy.Publisher('/RosBot_base_waypoints', Lane, queue_size=1, latch=True)
        self.pub_path = rospy.Publisher('/RosBot_base_path', Path, queue_size=1, latch=True)
    ...
    def publish(self):
        ...
        lane.waypoints = self.base_wp
        self.pub_wp.publish(lane)
