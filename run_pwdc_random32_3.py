...
def getConfig():
  ...
  configs["n"] = 5
  configs["m"] = 2
  configs["Sinit"] = np.array([0.1, 0.35, 0, 0, 0])
  configs["Sgoal"] = np.array([0.85, 0.6, 0 ,0, 0])
...
# linear init guess, Jcost =  15173125.954463549
# random init guess, Jcost =  21211768.592806555
